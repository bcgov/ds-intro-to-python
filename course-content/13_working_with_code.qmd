...
<left>
    <img src="images/working-with-code/jl_shifttab.png" size=600 style="margin:auto" border=1/>
    <p style="text-align: center">
</left>
...
<left>
    <img src="images/working-with-code/jl_syntaxerror.png" size=500 style="margin:auto" border=1/>
    <p style="text-align: center">
...
<left>
    <img src="images/working-with-code/jl_syntaxerror2.png" size=500 style="margin:auto" border=1/>
    <p style="text-align: center">
...
<left>
    <img src="images/working-with-code/nomodule.png" size=500 style="margin:auto" border=1/>
    <p style="text-align: center">
...
#| error: true
age = 54
years_to_100 = 100 - aege  # mis-spelled assigned variable called 'age'
```


<left>
    <img src="images/working-with-code/aege_not_defined.png" size=500 style="margin:auto" border=1/>
    <p style="text-align: center">     
